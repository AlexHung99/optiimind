// Extracted DC runtime. Site changes: local React, raw JSON template, no self-fetch.
"use strict";
(() => {
  ...
  function parseDcDocument(doc) {
    const dc = doc.getElementById("site-template");
    if (!dc) return null;
    ...
    return {
      template: JSON.parse(dc.textContent),
